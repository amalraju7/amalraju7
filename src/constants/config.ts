...
export const config: TConfig = {
  ...
  sections: {
    about: {
      ...
      JavaScript, and expertise in frameworks like React, Node.js, Angular,  Three.js,
      and Express.js . I'm a quick learner and collaborate closely with clients to
